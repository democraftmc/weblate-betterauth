...
SOCIAL_AUTH_CUSTOM_OIDC_PKCE_TITLE = os.environ.get('SOCIAL_AUTH_CUSTOM_OIDC_PKCE_TITLE')
SOCIAL_AUTH_CUSTOM_OIDC_PKCE_IMAGE = os.environ.get('SOCIAL_AUTH_CUSTOM_OIDC_PKCE_IMAGE')
